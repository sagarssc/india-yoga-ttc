  ...
  render() {
    ...
    return (
      ...
      <form onSubmit={this.handleSubmit} className="form">
        ...
        <input type="submit" value="Submit" className="label" style={{fontWeight:"700", color:'wheat',fontSize:"20px", width:"50%", backgroundColor:"#5c5889", height:"3rem", borderRadius:"2rem", display:"inline-flex", marginBottom:"2%", justifyContent:"center", marginLeft:"auto", marginRight:"auto"}}/>
      </form>}</div>
    );
  }
}