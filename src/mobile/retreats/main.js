      ...
      <div>
        ...
        <div className="our-teachers" style={{backgroundImage:"url('/home/bg/header.png')"}}>
            ...
            <div style={{display:"block", alignItems:"center", justifyContent:"center"}}>
              {RetreatTypes.map((retreat, index) => (<div style={{width:"95%", margin:"1%", height:"auto", backgroundColor:"#f1f1f1", borderRadius:"2rem"}}>
                ...
                <Link to={retreat.link} className="link"><div style={{margin:"8%",marginLeft:"25%", width:"50%", backgroundColor:"#5c5889", height:"3rem", borderRadius:"2rem", display:"inline-flex", marginTop:"1rem", boxShadow:"-2px 3px 5px 5px", justifyContent:"center", paddingTop:"2%"}}>
