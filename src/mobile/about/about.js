      ...
      <div>
        ...
        <div className="our-teachers" style={{backgroundImage:"url('/home/bg/header.png')"}}>
            ...
            <div style={{display:"flex", flexWrap:"wrap", alignItems:"center", justifyContent:"center"}}>
              {teachers.map((teacher, index) => (<div style={{width:"90%", margin:"1%", height:"auto", backgroundColor:"#f1f1f1", borderRadius:"2rem"}}>
                ...
                <div><p style={{margin:"2%", textAlign:"justify"}}>{teacher.description}</p></div>
              </div> ))}
            </div>
        </div>
