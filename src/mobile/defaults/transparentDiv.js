...
export default class TransparentDiv extends Component {
    render() {
        return (
          <div style={{margin:"auto",width:"70%", height:"100%", backgroundColor:"#e4dadab8", borderTopLeftRadius:"5rem", borderBottomRightRadius:"5rem", padding:"12%" }}>
            <text style={{margin:"auto", fontSize:"10px"}}>
            ...
            <h5 style={{margin:"auto", fontSize:"15px", fontWeight:"600"}}>
              — Elise Joan
            </h5>
          </div>
        );
